...
function NavBar({ auth }) {
    ...
    return (
        <nav className=" sticky top-0 z-50 rounded-full ">
                            ...
                            {openMegaMenu && (
                                <>
                                    ...
                                    >
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="mt-4 pt-4 border-t border-gray-100">
                                                            ...
                                                            {/* ✅ Verify Certificate in Column 2 */}
                                                            <Link 
                                                                href={route('certificate.verify.public.index')} 
                                                                onClick={() => setOpenMegaMenu(false)}
                                                                className="flex items-center px-3 py-2.5 rounded-lg hover:bg-green-50 transition duration-150 mt-1"
                                                            >
                                                                <svg className="w-4 h-4 text-green-600 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                                                </svg>
                                                                <div>
                                                                    <p className="text-sm font-medium text-gray-800">Verify Certificate</p>
                                        ...
                                        {/* ✅ Mega Menu Footer - Fixed Display */}
                                            ...
                                            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                                                ...
                                                <div className="flex items-center gap-3 flex-wrap">
                                                    <Link 
                                                        href={route('certificate.verify.public.index')}
                                                        onClick={() => setOpenMegaMenu(false)}
                                                        className="inline-flex items-center text-sm font-medium text-green-700 hover:text-green-900 bg-green-50 hover:bg-green-100 px-3 py-1.5 rounded-lg transition duration-200 whitespace-nowrap"
                                                    >
            ...
            {/* ✅ Mobile Menu - Fixed with all links */}
            {isMobileMenuOpen && (
                <div 
                    ref={mobileMenuRef}
                    className="lg:hidden bg-white border-t border-gray-100 shadow-lg fixed left-0 right-0 overflow-y-auto"
                    style={{ maxHeight: 'calc(100vh - 64px)', top: '64px' }}
                >
                    <div className="px-4 py-3 space-y-1">
                        ...
                        <Link 
                            href={route('certificate.verify.public.index')} 
                            className="flex items-center px-3 py-2.5 text-gray-700 hover:bg-green-50 hover:text-green-900 rounded-lg text-sm font-medium" 
