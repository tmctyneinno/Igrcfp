                                ...
                                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                    {!auth?.user ? (
                                        <>
                                            <Link
                                                href={route('register')}
                                                className="group bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-2 rounded-xl font-semibold text-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] shadow-lg hover:shadow-blue-500/25 inline-flex items-center justify-center"
                                            >
