        ...
        >
            <div className="relative max-w-7xl mx-auto px-0 sm:px-6 lg:px-8">
                <div className="flex flex-col lg:flex-row min-h-[600px] lg:min-h-[700px]">
                    ...
                    {/* Left Column - 50% with fade into right  */}
                    <div className="relative w-full lg:w-3/5 flex items-center py-12 lg:py-20">
                        ...
                        {/* Additional white fade on the right edge */}
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-white/80 lg:via-white/30"></div>

                        <div className="relative w-full max-w-xl mx-auto lg:mx-0 z-10 pr-0 lg:pr-8">
                                    ...
                                    {!auth?.user ? (
                                        <>
                                            ...
                                            <Link
                                                ...
                                                className="group bg-white/90 backdrop-blur-sm text-blue-900 px-8 py-3 rounded-xl font-semibold text-lg hover:bg-white transition-all duration-300 border-2 border-blue-900 hover:border-blue-700 transform hover:-translate-y-1 hover:scale-[1.02] shadow-md inline-flex items-center justify-center"
                                            >
                    ...
                    {/* Right Column - 50% Full Height Image Slider */}
                    <div className="relative w-full lg:w-3/5 h-[500px] lg:h-auto lg:min-h-[700px]">
                        <div className="relative w-full h-full overflow-hidden lg:rounded-none shadow-2xl">
