...
export default function CybersecurityPathway({auth}) {
    ...
    return (
        ...
        <GuestLayout auth={auth} forceWhiteNavbar>
            ...
            {/* Hero Section */}
             <HeroSection 
                title = " Cybersecurity, Technology & Digital Risk"
                description= "Focused on cyber risk as a governance, regulatory, and financial crime issue — not just an IT problemy"
            />
