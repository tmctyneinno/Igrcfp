    ...
    return (
        <>
         <GuestLayout auth={auth} forceWhiteNavbar>
            ...
            {/* Hero Section */}
            <HeroSection 
                title = "Financial Crime Prevention & Regulatory Compliance"
                description= "Focused on preventing, detecting, and responding to economic and financial crime across industries"
            />
