        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-auto">
                <div class="d-flex flex-wrap align-items-center gap-0">
                    <button type="button" class="sidebar-toggle"  onClick={() => setSidebarOpen(!isSidebarOpen)}>
                    <iconify-icon icon="heroicons:bars-3-solid" class="icon text-2xl non-active"></iconify-icon>
                    <iconify-icon icon="iconoir:arrow-right" class="icon text-2xl active"></iconify-icon>
                    </button>
                    <button type="button" class="sidebar-mobile-toggle" onClick={() => setMobileSidebarOpen(!isMobileSidebarOpen)}>
...
// Note: The component is already a default export
