...
export default function Blog({ auth, title, description }) {
    return (
        <GuestLayout auth={auth}>
            ...
            <section className="w-full bg-gradient-to-r from-blue-500 via-blue-600 to-green-500 my-16 py-8 px-4 md:py-12 md:px-6 lg:py-16 lg:px-8">
