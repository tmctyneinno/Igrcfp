            ...
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                    <div className="text-center mb-6">
                        ...
                        <h3 className="text-1xl font-semibold mb-2"> Institute of GRC and Financial Crime Prevention (IGRCFP)</h3>
                ...
                <div className="flex items-start pt-3 border-t border-purple-100">
                    ...
                    <div>
                        <p className="text-sm text-gray-800">
                            ...
                            <span className="font-semibold text-purple-700"> 2–3 working days</span>
                        </p>
