                                                            ...
                                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                                ...
                                                                >
                                                                    <div className="text-center">
                                                                        ...
                                                                        <h4 className="font-semibold text-lg mb-2">Instructor</h4>
                                                                        <p className="text-sm text-gray-600">
                                                                ...
                                                                >
                                                                    <div className="text-center">
                                                                        ...
                                                                        <p className="text-sm text-gray-600">
                                                                            Manage platform settings, users, and overall system operations
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="space-y-6" data-aos="fade-up">
                                                            ...
                                                            <div className="flex justify-between pt-4">
                                                                ...
                                                                <div className="flex space-x-4">
                                                                    <Link
                                                                        href={route('login')}
                                                                        className="px-6 py-3 border border-gray-300 rounded-md font-medium text-gray-700 hover:bg-gray-50 inline-flex items-center"
                                                                    >
                                                                        Already registered?
                                                                    </Link>
                                                                    <PrimaryButton 
