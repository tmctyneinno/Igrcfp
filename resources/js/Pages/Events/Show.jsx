                                ...
                                <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 mb-8">
                                    ...
                                    {event.registration_status === 'sold_out' ? (
                                        ...
                                        <Link
                                            ...
                                            className="block w-full text-center py-3 px-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl"
                                        >
                                            Register Now
                                        </Link>
                                    )}
