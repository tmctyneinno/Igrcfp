        ...
        <GuestLayout auth={auth}>
            ...
            <section className="py-12 bg-gradient-to-r from-blue-50 to-indigo-50">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <Link
                        href={route('contact')}
                        className="inline-flex items-center px-3 py-3  from-blue-900 to-indigo-800 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow hover:shadow-md transform hover:-translate-y-0.5"
                    >
                        Contact Us
