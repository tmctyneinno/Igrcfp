...
export default function Show({ document, auth }) {
    ...
    function CopyLinkButton({ fileUrl }) {
        ...
        return (
            <button 
                onClick={handleCopy}
                className="relative flex items-center justify-center gap-2 bg-gray-700 hover:bg-gray-800 text-white py-2 px-3 rounded-lg text-sm transition"
            >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h4a2 2 0 002-2M8 5a2 2 0 012-2h4a2 2 0 012 2m0 0h2a2 2 0 012 2v3m0 0V9a2 2 0 00-2-2h-2M5 11h2m-2 4h2" />
                </svg>
                {copied ? 'Copied!' : 'Copy Link'}
                {copied && (
                    <span className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-xs px-2 py-1 rounded shadow">
                        Link copied!
                    </span>
                )}
            </button>
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white rounded-xl shadow-sm p-6 mb-6 border border-gray-100">
                                ...
                                {document.description && (
                                    <div className="prose max-w-none text-gray-700">
                                        <p className="text-base leading-relaxed">{document.description}</p>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                                ...
                                <div className="w-full h-[700px] border border-gray-200 rounded-lg overflow-hidden">
                                    <iframe 
                                        src={`/storage/${document.file_path}#toolbar=0&navpanes=0`}
                                ...
                                <p className="text-sm text-gray-500 mt-3 text-center">
                                    If the preview does not load, you can download the document using the button below.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 sticky top-24">
                                ...
                                <a 
                                    ...
                                    className="w-full bg-blue-900 hover:bg-blue-800 text-white font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition duration-200 mb-4"
                                >
                                ...
                                <a 
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition duration-200 mb-6"
                                >
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6v6m0-10L10 14" />
                                    </svg>
                                    Open in New Tab
                                </a>
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <a 
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center justify-center gap-2 bg-[#1877F2] hover:bg-[#166FE5] text-white py-2 px-3 rounded-lg text-sm transition"
                                        >
                                        ...
                                        <a 
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center justify-center gap-2 bg-black hover:bg-gray-800 text-white py-2 px-3 rounded-lg text-sm transition"
                                        >
                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <a 
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex items-center justify-center gap-2 bg-[#0A66C2] hover:bg-[#0958A9] text-white py-2 px-3 rounded-lg text-sm transition"
                                        >
                                            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
