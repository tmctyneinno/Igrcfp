                            ...
                            <div class="col-12">
                                <div class="alert alert-info d-flex align-items-center" role="alert">
                                    ...
                                    <div>
                                        ...
                                        <span id="courseTypeIndicator" class="badge bg-{{ $course->price == 0 ? 'success' : ($course->discount_price > 0 && $course->discount_price < $course->price ? 'warning' : 'primary') }} ms-2">
                            ...
                            <div class="col-12">
                                <div id="pricingPreview" class="mt-3 p-3 bg-light rounded-8">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <span id="finalPriceDisplay" class="h4 mb-0 {{ $course->price == 0 ? 'text-success' : ($course->discount_price > 0 ? 'text-danger' : 'text-primary') }}">
                                            @if($course->price == 0)
                                                FREE
                                    ...
                                    <div id="discountInfo" class="mt-2" style="display: {{ $course->discount_price > 0 && $course->discount_price < $course->price ? 'block' : 'none' }};">
                                        @if($course->discount_price > 0 && $course->discount_price < $course->price)
                                            <span class="badge bg-danger" id="discountBadge">
                                                Save {{ $course->discount_percentage }}% (${{ number_format($course->price - $course->discount_price, 2) }})
                                            </span>
                                        @endif
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="career_pathways" name="career_pathways" class="form-control rich-editor @error('career_pathways') is-invalid @enderror" rows="4">{{ old('career_pathways', $course->career_pathways) }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="assessment_structure" name="assessment_structure" class="form-control rich-editor  @error('assessment_structure') is-invalid @enderror" rows="4">{{ old('assessment_structure', $course->assessment_structure) }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="code_of_conduct" name="code_of_conduct" class="form-control rich-editor @error('code_of_conduct') is-invalid @enderror" rows="4">{{ old('code_of_conduct', $course->code_of_conduct) }}</textarea>
                ...
                <div class="card mt-24">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="bulk_modules" class="form-control rich-editor @error('bulk_modules') is-invalid @enderror" rows="15">{{ old('bulk_modules') }}</textarea>
                            @error('bulk_modules')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="meta_keywords" id="meta_keywords" class="form-control rich-editor @error('meta_keywords') is-invalid @enderror" 
                                          rows="3" maxlength="200">{{ old('meta_keywords', $course->meta_keywords) }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.processBulkUpdate = function() {
        const updateMethod = document.querySelector('input[name="update_method"]:checked').value;
        $('#bulkUpdateModal').modal('hide');
        alert(`Bulk update will be processed using "${updateMethod}" method.`);
    };
