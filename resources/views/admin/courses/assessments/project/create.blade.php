...
<div class="dashboard-main-body">
    ...
    <form action="{{ route('admin.assessments.store') }}" method="POST" enctype="multipart/form-data" id="projectForm">
        @csrf
                ...
                <div class="card mt-24">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="project_brief" class="form-control rich-editor @error('project_brief') is-invalid @enderror" 
                                      rows="6" placeholder="Provide a detailed project brief including objectives, scope, and requirements..." required>{{ old('project_brief') }}</textarea>
                            @error('project_brief') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold">Deliverables</label>
                            <textarea name="deliverables" class="form-control @error('deliverables') is-invalid @enderror" 
                                      rows="4" placeholder="List the expected deliverables (one per line)">{{ old('deliverables') }}</textarea>
                         ...
                         <div class="mb-3">
                            ...
                            <textarea name="instruction" class="form-control @error('instruction') is-invalid @enderror" 
                                      rows="4" placeholder="List the expected instruction (one per line)">{{ old('instruction') }}</textarea>
                            <p class="text-muted small mt-1">Enter each deliverable on a new line</p>
