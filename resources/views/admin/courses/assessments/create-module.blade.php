...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Create Module Assessment</h6>
        <ul class="d-flex align-items-center gap-2">
            ...
            <li>-</li>
            <li class="fw-medium">Create Module Assessment</li>
        </ul>
    </div>
    ...
    <form action="{{ route('admin.assessments.store') }}" method="POST" enctype="multipart/form-data" id="moduleForm">
        @csrf
        <input type="hidden" name="assessment_level" value="module_assessment">
        ...
        <div class="row gy-4">
                        ...
                        <div class="row gy-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" 
                                       value="{{ old('title') }}" placeholder="e.g., Module 3 Assessment" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" 
                                          rows="3" placeholder="Describe the assessment">{{ old('description') }}</textarea>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h6 class="card-title mb-0">Assessment Settings</h6>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="weight" class="form-control" value="{{ old('weight', 25) }}" min="1" max="100">
                        </div>
                    </div>
                </div>
                ...
                <div class="card mt-24">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="duration" class="form-control" value="{{ old('duration', 60) }}" min="1">
                        </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-12 essay-container" style="display: none;">
                    <div class="border rounded-3 p-3 bg-light">
                        ...
                        <textarea name="questions[{idx}][correct_answer]" class="form-control" rows="4" placeholder="Describe what should be included in a good answer, grading criteria, and expected key points..."></textarea>
                        <p class="text-muted small mt-2 mb-0">
                            <iconify-icon icon="solar:info-circle-outline" class="me-1"></iconify-icon>
