<div class="navbar-header">
    <div class="row align-items-center justify-content-between">
        ...
        <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <div class="dropdown" id="admin-notification-dropdown">
                <button id="admin-notification-button" class="w-40-px h-40-px bg-neutral-200 rounded-circle d-flex justify-content-center align-items-center position-relative" type="button" data-bs-toggle="dropdown">
                ...
                <div class="dropdown-menu to-top dropdown-menu-lg p-0">
                    ...
                    <span id="admin-notification-count" class="text-primary-600 fw-semibold text-lg w-40-px h-40-px rounded-circle bg-base d-flex justify-content-center align-items-center">0</span>
                    </div>
                    
                    <div id="admin-notification-list" class="max-h-400-px overflow-y-auto scroll-sm pe-4">
                        <div class="px-24 py-24 text-center text-secondary-light text-sm">Loading notifications...</div>
                    </div>

                    <div class="text-center py-12 px-16"> 
                        <button type="button" id="admin-notification-mark-all" class="text-primary-600 fw-semibold text-md border-0 bg-transparent">Mark All As Read</button>
                    </div>
                </div>
            </div>
